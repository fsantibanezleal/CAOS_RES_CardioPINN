    ...
    <div className="page-body prose">
      ...
      {tab === 'ecgi-fwd' && (
        <section>
          ...
          <Refs ids={['barr1977', 'vanoosterom1983', 'bear2018']} />
        </section>
      )}
      ...
      {tab === 'ecgi-rec' && (
        <section>
          ...
          <Refs ids={['tikhonov1977', 'ghosh2009', 'lakshminarayanan2017']} />
        </section>
      )}
