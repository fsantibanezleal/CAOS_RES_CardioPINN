    ...
    },
    {
      ...
      content: (
        <section>
          ...
          <Callout>{pick(lang, 'Results, ensemble mean (the shipped reconstruction, vs the REAL heart cage): human sinus RE 0.67 / CC 0.72, PVP 0.67 / 0.71, AVP 0.57 / 0.80; dog sinus 0.59 / 0.73; node-UQ ~0.90. The zeroth-order Tikhonov baseline it is compared against is modestly more accurate (sinus 0.65 / 0.72, PVP 0.58 / 0.80, AVP 0.54 / 0.85, dog 0.54 / 0.78). Same pipeline, no per-heart retuning, so the numbers measure a method.', 'Resultados, media del ensemble (la reconstruccion desplegada, vs la jaula REAL): humano sinusal RE 0.67 / CC 0.72, PVP 0.67 / 0.71, AVP 0.57 / 0.80; perro sinusal 0.59 / 0.73; UQ nodo ~0.90. La linea base Tikhonov de orden cero con la que se compara es modestamente mas precisa (sinusal 0.65 / 0.72, PVP 0.58 / 0.80, AVP 0.54 / 0.85, perro 0.54 / 0.78). Mismo pipeline, sin reajuste, asi que los numeros miden un metodo.')}</Callout>
