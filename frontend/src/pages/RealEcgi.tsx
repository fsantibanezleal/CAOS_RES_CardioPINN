    ...
    <div className="page-body prose">
      ...
      {tab === 'forward' && (
        <section>
          ...
          <Callout>
            {pick(lang,
              'We use a single-layer approximation of A on the real geometry rather than a full boundary-element operator with the closed torso mesh and per-tissue conductivities. This is honest and self-contained but caps the absolute accuracy; a full BEM forward is the natural next improvement.',
              'Usamos una aproximacion de capa simple de A sobre la geometria real en lugar de un operador de elementos de contorno completo con la malla cerrada del torso y conductividades por tejido. Esto es honesto y autocontenido pero limita la precision absoluta; un operador BEM completo es la siguiente mejora natural.')}
          </Callout>
