      ...
      {tab === 'result' && tr && (
        <section>
          ...
          <p style={{ marginTop: 12 }}>{pick(lang,
            'Orbit the aortic lumen; toggle the recovered relative pressure (at peak systole) and the measured speed (scrub or play the cardiac cycle). The recovered pressure field spans a physiological range of a few to about fifteen mmHg across the segment and brackets the clinical Bernoulli estimate from the same scan, exactly what the physics-based map should do on an unobstructed aorta while also revealing where the pressure varies, which the single Bernoulli number cannot.',
