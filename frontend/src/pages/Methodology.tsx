      ...
      content: (
        <section>
          ...
          <p>{pick(lang,
            ...
            'El operador que esta implementacion realmente calcula e invierte es una aproximacion de fuente puntual en medio no acotado (capa simple): A mapea cada nodo de la jaula cardiaca a cada electrodo corporal por el reciproco de su distancia, suavizado y normalizado por filas para el condicionamiento, con una ganancia escalar calibrada en la primera mitad del latido, luego fijada y aplicada a toda la matriz. Se evalua sobre las posiciones REALES de los electrodos del experimento EDGAR, no sobre una malla generica. Un operador de elementos de contorno homogeneo tambien esta implementado y probado analiticamente en el problema de esferas concentricas (ver la pestana Pruebas analiticas), pero las superficies de electrodos de EDGAR son nubes de puntos abiertas, no las 2-variedades cerradas que un BEM necesita, asi que la reconstruccion recae en el operador de capa simple y el BEM corre solo como comparacion offline en geometrias de catalogo de variedad cerrada. El BEM completo de torso cerrado con conductividades por tejido es el siguiente paso natural.')}</p>
  ...
  return (
    <div className="page-body prose">
      ...
      <SubTabs
        ...
        ariaLabel={pick(lang, 'Method families', 'Familias de metodo')}
      />
    </div>
  );
}
