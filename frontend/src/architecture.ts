...
export const architecture: ArchitectureConfig = {
  ...
  tabs: [
    ...
    {
      id: 'contracts', en: 'Data contracts / design', es: 'Contratos de datos / diseno', svg: SVG_CONTRACTS,
