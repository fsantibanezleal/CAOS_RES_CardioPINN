...
const config: ShellConfig = {
  ...
  footer: {
    provenance: {
      en: 'Data: EDGAR / Consortium for ECG Imaging (Aras 2015, CC-attribution) + a real thoracic-aorta 4D-flow MRI; engines: graph-Tikhonov ECGi + Navier-Stokes pressure-Poisson PINN',
      es: 'Datos: EDGAR / Consortium for ECG Imaging (Aras 2015, CC-atribucion) + una resonancia real de flujo 4D de aorta toracica; motores: ECGi Tikhonov-grafo + PINN de Poisson de presion Navier-Stokes',
    },
    disclaimer: {
